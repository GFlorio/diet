...
export function setupReport(){
  ...
  const inRange = /** @type {Meal[]} */ (await Meals.listRange(from, to));
    ...
    for (const m of inRange){
      ...
      days[k].kcal += s.kcal*q; days[k].prot += s.prot*q; days[k].carbs += s.carbs*q; days[k].fats += s.fats*q;
    }
